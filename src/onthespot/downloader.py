                ...
                try:
                    ...
                    if is_retryable:
                        ...
                        if attempt < max_retries_per_account - 1:
                            ...
                            is_idle_timeout = (error_type == 'Empty' or 'Bad file descriptor' in error_str)
                            self.update_progress(item, "Connecting" if is_idle_timeout else "Reconnecting", item.get('progress', 0))
                            try:
                    ...
                    if download_queue:
                        with download_queue_lock:
                            ...
                            available_items = [
                                ...
                                if item['available'] and item['item_status'] in ('Waiting', 'Connecting', 'Reconnecting')
                            ]
